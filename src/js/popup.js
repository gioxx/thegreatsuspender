...
(function(global) {
  ...
  let getTabStatus = function(retriesRemaining, callback) {
  ...
  ]).then(function([initialTabStatus, selectedTabs]) {
  ...
  function setStatus(status) {
    ...
    let actionEl = document.getElementsByTagName('a')[0];
    if (actionEl) {
      let tgsHanderFunc;
      if (
